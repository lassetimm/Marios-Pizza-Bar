...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Order pizzaOrder1 = new Order(new Pizza[]{margarita, margarita}, "Lasse", "112", "7:30");
        Order pizzaOrder2 = new Order(new Pizza[]{vesuvio, leBlissola}, "Lasse", "112", "7:30");
        Order pizzaOrder3 = new Order(new Pizza[]{carbona, margarita}, "Lasse", "112", "7:30");
        Order pizzaOrder4 = new Order(new Pizza[]{silvia, margarita}, "Lasse", "112", "7:30");
        Order pizzaOrder5 = new Order(new Pizza[]{silvia, margarita}, "Lasse", "112", "7:30");
        Order pizzaOrder6 = new Order(new Pizza[]{carbona, margarita}, "Lasse", "112", "7:30");
        Order pizzaOrder7 = new Order(new Pizza[]{carbona, margarita}, "Lasse", "112", "7:30");
        Order pizzaOrder8 = new Order(new Pizza[]{silvia, margarita}, "Lasse", "112", "7:30");


        Statistics statistics = new Statistics(new Order[]{pizzaOrder1,pizzaOrder2,pizzaOrder3,pizzaOrder4,pizzaOrder5,pizzaOrder6,pizzaOrder7,pizzaOrder8});
        statistics.numberOfPizzas();
